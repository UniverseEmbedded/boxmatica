package pama1234.boxmatica.tool;
...
public enum ToolMode implements StringIdentifiable{
  AREA_SELECTION("area_selection","boxmatica.tool_mode.name.area_selection",false,false),
  SCHEMATIC_PLACEMENT("schematic_placement","boxmatica.tool_mode.name.schematic_placement",false,true),
  FILL("fill","boxmatica.tool_mode.name.fill",true,false,true,false),
  REPLACE_BLOCK("replace_block","boxmatica.tool_mode.name.replace_block",true,false,true,true),
  PASTE_SCHEMATIC("paste_schematic","boxmatica.tool_mode.name.paste_schematic",true,true),
  GRID_PASTE("grid_paste","boxmatica.tool_mode.name.grid_paste",true,true),
  MOVE("move","boxmatica.tool_mode.name.move",true,false),
  DELETE("delete","boxmatica.tool_mode.name.delete",true,false),
  REBUILD("rebuild","boxmatica.tool_mode.name.rebuild",false,true,true,false);
