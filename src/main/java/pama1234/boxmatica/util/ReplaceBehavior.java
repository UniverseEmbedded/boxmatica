...
public enum ReplaceBehavior implements IConfigOptionListEntry,StringIdentifiable{
  NONE("none","boxmatica.gui.label.replace_behavior.none"),
  ALL("all","boxmatica.gui.label.replace_behavior.all"),
  WITH_NON_AIR("with_non_air","boxmatica.gui.label.replace_behavior.with_non_air");
