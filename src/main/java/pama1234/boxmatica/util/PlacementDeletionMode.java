...
public enum PlacementDeletionMode implements IConfigOptionListEntry,StringIdentifiable{
  MATCHING_BLOCK("matching_block","boxmatica.gui.label.placement_deletion_mode.matching_block"),
  NON_MATCHING_BLOCK("non_matching_block","boxmatica.gui.label.placement_deletion_mode.non_matching_block"),
  ANY_SCHEMATIC_BLOCK("any_schematic_block","boxmatica.gui.label.placement_deletion_mode.any_schematic_block"),
  NO_SCHEMATIC_BLOCK("no_schematic_block","boxmatica.gui.label.placement_deletion_mode.no_schematic_block"),
  ENTIRE_VOLUME("entire_volume","boxmatica.gui.label.placement_deletion_mode.entire_volume");
