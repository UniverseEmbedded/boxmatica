...
public enum PasteNbtBehavior implements IConfigOptionListEntry,StringIdentifiable{
  NONE("none","boxmatica.gui.label.paste_nbt_behavior.none"),
  PLACE_MODIFY("place_data_modify","boxmatica.gui.label.paste_nbt_behavior.place_data_modify"),
  PLACE_CLONE("place_clone","boxmatica.gui.label.paste_nbt_behavior.place_clone");
