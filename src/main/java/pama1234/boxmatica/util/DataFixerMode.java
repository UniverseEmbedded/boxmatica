...
public enum DataFixerMode implements IConfigOptionListEntry,StringIdentifiable{
  ALWAYS("always","boxmatica.gui.label.data_fixer_mode.always"),
  BELOW_1215("below_1215","boxmatica.gui.label.data_fixer_mode.below_1215"),
  BELOW_1205("below_1205","boxmatica.gui.label.data_fixer_mode.below_1205"),
  BELOW_120X("below_120X","boxmatica.gui.label.data_fixer_mode.below_120X"),
  BELOW_119X("below_119X","boxmatica.gui.label.data_fixer_mode.below_119X"),
  BELOW_117X("below_117X","boxmatica.gui.label.data_fixer_mode.below_117X"),
  BELOW_116X("below_116X","boxmatica.gui.label.data_fixer_mode.below_116X"),
  BELOW_113X("below_113X","boxmatica.gui.label.data_fixer_mode.below_113X"),
  BELOW_112X("below_112X","boxmatica.gui.label.data_fixer_mode.below_112X"),
  NEVER("never","boxmatica.gui.label.data_fixer_mode.never");
