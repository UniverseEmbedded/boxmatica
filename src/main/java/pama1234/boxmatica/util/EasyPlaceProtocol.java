...
public enum EasyPlaceProtocol implements IConfigOptionListEntry,StringIdentifiable{
  AUTO("auto","boxmatica.gui.label.easy_place_protocol.auto"),
  V3("v3","boxmatica.gui.label.easy_place_protocol.v3"),
  V2("v2","boxmatica.gui.label.easy_place_protocol.v2"),
  SLAB_ONLY("slabs_only","boxmatica.gui.label.easy_place_protocol.slabs_only"),
  NONE("none","boxmatica.gui.label.easy_place_protocol.none");
