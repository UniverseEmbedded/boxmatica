...
public class PlacementHandler{
  ...
  public static <T extends Comparable<T>> BlockState applyPlacementProtocolV3(BlockState state,UseContext context) {
    ...
    try {
      ...
      Boxmatica.LOGGER.warn("Exception trying to apply placement protocol value",e);
    }
  ...
  public static class UseContext{
    ...
    /*
     * public static UseContext of(World world, BlockPos pos, Direction side, Vec3d hitVec,
