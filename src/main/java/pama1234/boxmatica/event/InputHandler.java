...
public class InputHandler implements IKeybindProvider,IKeyboardInputHandler,IMouseInputHandler{
  ...
  public boolean onMouseScroll(int mouseX,int mouseY,double dWheel) {
    //Boxmatica.debugLog("Mouse scroll: x: {}, y; {}, wheel: {}", mouseX, mouseY, dWheel);
    MinecraftClient mc=MinecraftClient.getInstance();
    ...
    if(mode.getUsesAreaSelection()) {
      ...
      if(area!=null) {
        ...
        if(box!=null) {
          ...
          InfoUtils.showGuiOrInGameMessage(MessageType.ERROR,"boxmatica.error.area_selection.grow.no_sub_region_selected");
        }
      }else {
