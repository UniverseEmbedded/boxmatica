...
public class TaskFillArea extends TaskProcessChunkMultiPhase{
  ...
  public TaskFillArea(List<Box> boxes,BlockState fillState,@Nullable BlockState replaceState,boolean removeEntities) {
    this(boxes,fillState,replaceState,removeEntities,"boxmatica.gui.label.task_name.fill");
  }
  ...
  protected void printCompletionMessage() {
    if(this.finished) {
      if(this.printCompletionMessage) {
        InfoUtils.showGuiMessage(MessageType.SUCCESS,"boxmatica.message.area_filled");
      }
    }else {
      InfoUtils.showGuiMessage(MessageType.ERROR,"boxmatica.message.area_fill_fail");
    }
  }
}
