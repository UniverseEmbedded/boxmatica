...
import pama1234.boxmatica.scheduler.ITask;
import pama1234.boxmatica.scheduler.TaskTimer;
...
public abstract class TaskBase implements ITask,IInfoHudRenderer{
  ...
  protected void updateInfoHudLinesPendingChunks(Collection<ChunkPos> pendingChunks) {
    ...
    if(pendingChunks.isEmpty()==false) {
      ...
      String title=StringUtils.translate("boxmatica.gui.label.task.title.remaining_chunks",this.getDisplayName(),pendingChunks.size());
