...
import pama1234.boxmatica.render.schematic.ao.AOProcessor;
import pama1234.boxmatica.render.schematic.ao.AOProcessorModern;
...
public class BlockModelRendererSchematic{
  ...
  public boolean renderModel(BlockRenderView worldIn,List<BlockModelPart> modelParts,BlockState stateIn,
    ...
    try {
      ...
      //Boxmatica.logger.error("renderModel: Crash caught: [{}]", !throwable.getMessage().isEmpty() ? throwable.getMessage() : "<EMPTY>");
  ...
  /*
   * private void fillQuadBounds(BlockRenderView world, BlockState stateIn, BlockPos pos, int[]
   * vertexData, Direction face, @Nullable float[] quadBounds, BitSet boundsFlags)
   * {
   * float f = 32.0F;
   * float f1 = 32.0F;
   * float f2 = 32.0F;
   ...
   * boundsFlags.set(0, (f1 < 1.0E-4F || Block.isShapeFullCube(stateIn.getCollisionShape(world,
   * pos))) && f1 == f4);
   * break;
   * case UP:
   * boundsFlags.set(1, f >= 1.0E-4F || f2 >= 1.0E-4F || f3 <= 0.9999F || f5 <= 0.9999F);
   * boundsFlags.set(0, (f4 > 0.9999F || Block.isShapeFullCube(stateIn.getCollisionShape(world,
   * pos))) && f1 == f4);
   * break;
   * case NORTH:
   * boundsFlags.set(1, f >= 1.0E-4F || f1 >= 1.0E-4F || f3 <= 0.9999F || f4 <= 0.9999F);
   * boundsFlags.set(0, (f2 < 1.0E-4F || Block.isShapeFullCube(stateIn.getCollisionShape(world,
   * pos))) && f2 == f5);
   * break;
   * case SOUTH:
   * boundsFlags.set(1, f >= 1.0E-4F || f1 >= 1.0E-4F || f3 <= 0.9999F || f4 <= 0.9999F);
   * boundsFlags.set(0, (f5 > 0.9999F || Block.isShapeFullCube(stateIn.getCollisionShape(world,
   * pos))) && f2 == f5);
   * break;
   * case WEST:
   * boundsFlags.set(1, f1 >= 1.0E-4F || f2 >= 1.0E-4F || f4 <= 0.9999F || f5 <= 0.9999F);
   * boundsFlags.set(0, (f < 1.0E-4F || Block.isShapeFullCube(stateIn.getCollisionShape(world,
   * pos))) && f == f3);
   * break;
   * case EAST:
   * boundsFlags.set(1, f1 >= 1.0E-4F || f2 >= 1.0E-4F || f4 <= 0.9999F || f5 <= 0.9999F);
   * boundsFlags.set(0, (f3 > 0.9999F || Block.isShapeFullCube(stateIn.getCollisionShape(world,
   * pos))) && f == f3);
   * }
   * }
   */
