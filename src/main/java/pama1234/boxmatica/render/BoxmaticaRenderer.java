...
import pama1234.boxmatica.compat.iris.IrisCompat;
...
public class BoxmaticaRenderer{
  private static final BoxmaticaRenderer INSTANCE=new BoxmaticaRenderer();
  ...
  private BoxmaticaRenderer() {}

  public static BoxmaticaRenderer getInstance() {
    return INSTANCE;
  }
   ...
   * {
   * this.mc.getProfiler().push("boxmatica_schematic_world_render");
   * 
   ...
   * }
   * 
   * private void renderWorld(MatrixStack matrices, Matrix4f matrix, float partialTicks, long
   * finishTimeNano)
   * {
  ...
  public void piecewiseRenderSolid(Matrix4f viewMatrix,Matrix4f posMatrix,Profiler profiler) {
    if(this.renderPiecewiseBlocks) {
      ...
      this.getWorldRenderer().renderBlockLayer(RenderLayer.getSolid(),this.getCamera(),profiler,
        this.renderCollidingSchematicBlocks?MaLiLibPipelines.SOLID_MASA_OFFSET:MaLiLibPipelines.SOLID_MASA);
  ...
  public void piecewiseRenderCutoutMipped(Matrix4f viewMatrix,Matrix4f posMatrix,Profiler profiler) {
    if(this.renderPiecewiseBlocks) {
      ...
      this.getWorldRenderer().renderBlockLayer(RenderLayer.getCutoutMipped(),this.getCamera(),profiler,
        this.renderCollidingSchematicBlocks?MaLiLibPipelines.CUTOUT_MIPPED_MASA_OFFSET:MaLiLibPipelines.CUTOUT_MIPPED_MASA);
  ...
  public void piecewiseRenderCutout(Matrix4f viewMatrix,Matrix4f posMatrix,Profiler profiler) {
    if(this.renderPiecewiseBlocks) {
      ...
      this.getWorldRenderer().renderBlockLayer(RenderLayer.getCutout(),this.getCamera(),profiler,
        this.renderCollidingSchematicBlocks?MaLiLibPipelines.CUTOUT_MASA_OFFSET:MaLiLibPipelines.CUTOUT_MASA);
  ...
  public void piecewiseRenderTranslucent(Matrix4f viewMatrix,Matrix4f posMatrix,Profiler profiler) {
    if(this.renderPiecewiseBlocks) {
      ...
      this.getWorldRenderer().renderBlockLayer(RenderLayer.getTranslucent(),this.getCamera(),profiler,
        this.renderCollidingSchematicBlocks?MaLiLibPipelines.TRANSLUCENT_MASA_OFFSET:MaLiLibPipelines.TRANSLUCENT_MASA);
  ...
  public void piecewiseRenderTripwire(Matrix4f viewMatrix,Matrix4f posMatrix,Profiler profiler) {
    if(this.renderPiecewiseBlocks) {
      ...
      this.getWorldRenderer().renderBlockLayer(RenderLayer.getTripwire(),this.getCamera(),profiler,
        this.renderCollidingSchematicBlocks?MaLiLibPipelines.TRIPWIRE_MASA_OFFSET:MaLiLibPipelines.TRIPWIRE_MASA);
