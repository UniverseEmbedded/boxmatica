package pama1234.boxmatica.compat.jade;
...
/**
 * This is just a compat class to "move" the Info Overlay lower so the window doesn't clash as
 * bad.
 */
public class JadeCompat{
  ...
  public static void checkForJade() {
    ...
    if(!Objects.equals(jadeVer,"?")) {
      Boxmatica.debugLog("Detected Jade version {}.",jadeVer);
      hasJade=true;
    }else {
      hasJade=false;
    }
