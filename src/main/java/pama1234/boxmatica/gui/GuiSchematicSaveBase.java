...
public abstract class GuiSchematicSaveBase extends GuiSchematicBrowserBase implements ISelectionListener<DirectoryEntry>{
  ...
  @Nullable
  protected final BoxmaticaSchematic schematic;

  public GuiSchematicSaveBase(@Nullable BoxmaticaSchematic schematic) {
    super(10,80);
    ...
    this.checkboxSaveFromSchematicWorld=new WidgetCheckBox(0,0,Icons.CHECKBOX_UNSELECTED,Icons.CHECKBOX_SELECTED,StringUtils.translate("boxmatica.gui.label.schematic_save.checkbox.save_from_schematic_world"),StringUtils.translate("boxmatica.gui.label.schematic_save.hover_info.save_from_schematic_world"));
  }
  ...
  public void initGui() {
    ...
    String str=StringUtils.translate("boxmatica.gui.label.schematic_save.checkbox.ignore_entities");
    ...
    this.checkboxVisibleOnly=new WidgetCheckBox(x,y+24,Icons.CHECKBOX_UNSELECTED,Icons.CHECKBOX_SELECTED,StringUtils.translate("boxmatica.gui.label.schematic_save.checkbox.visible_blocks_only"));
    this.addWidget(this.checkboxVisibleOnly);

    this.checkboxIncludeSupportBlocks=new WidgetCheckBox(x,y+36,Icons.CHECKBOX_UNSELECTED,Icons.CHECKBOX_SELECTED,StringUtils.translate("boxmatica.gui.label.schematic_save.checkbox.support_blocks"),StringUtils.translate("boxmatica.gui.label.schematic_save.hover_info.support_blocks"));
  ...
  private int createButton(int x,int y,ButtonType type) {
    ...
    if(type==ButtonType.SAVE) {
      button=new ButtonGeneric(x,y,width,20,label,"boxmatica.gui.label.schematic_save.hover_info.hold_shift_to_overwrite");
    }else {
  ...
  public enum ButtonType{
    SAVE("boxmatica.gui.button.save_schematic");
