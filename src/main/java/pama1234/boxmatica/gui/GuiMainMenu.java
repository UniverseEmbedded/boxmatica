...
public class GuiMainMenu extends GuiBase{
  public GuiMainMenu() {
    ...
    this.title=StringUtils.translate("boxmatica.gui.title.boxmatica_main_menu",version);
  }
  ...
  public void initGui() {
    ...
    String label=StringUtils.translate("boxmatica.gui.button.area_selection_mode",mode.getDisplayName());
    ButtonGeneric button=new ButtonGeneric(x,y,width,20,label);
    this.addButton(button,new ButtonListenerCycleAreaMode(this));

    label=StringUtils.translate("boxmatica.gui.button.tool_mode",DataManager.getToolMode().getName());
  ...
  private void createChangeMenuButton(int x,int y,int width,ButtonListenerChangeMenu.ButtonType type) {
    ...
    if(type==ButtonListenerChangeMenu.ButtonType.AREA_SELECTION_BROWSER&&
      ...
      button.setHoverStrings("boxmatica.gui.button.hover.schematic_projects.menu_warning");
    }
  ...
  public static class ButtonListenerChangeMenu implements IButtonActionListener{
    ...
    public enum ButtonType{
      ...
      LOADED_SCHEMATICS("boxmatica.gui.button.change_menu.show_loaded_schematics",ButtonIcons.LOADED_SCHEMATICS),
      // List Schematics placements
      SCHEMATIC_PLACEMENTS("boxmatica.gui.button.change_menu.show_schematic_placements",ButtonIcons.SCHEMATIC_PLACEMENTS),
      // Open the Area Selection browser
      AREA_SELECTION_BROWSER("boxmatica.gui.button.change_menu.show_area_selections",ButtonIcons.AREA_SELECTION),
      // Open the Area Editor GUI
      AREA_EDITOR("boxmatica.gui.button.change_menu.area_editor",ButtonIcons.AREA_EDITOR),
      // Load Schematics from file to memory
      LOAD_SCHEMATICS("boxmatica.gui.button.change_menu.load_schematics_to_memory",ButtonIcons.SCHEMATIC_BROWSER),
      // Edit Schematics (description or icon), or convert between formats
      SCHEMATIC_MANAGER("boxmatica.gui.button.change_menu.schematic_manager",ButtonIcons.SCHEMATIC_MANAGER),
      // Open the Task Manager
      TASK_MANAGER("boxmatica.gui.button.change_menu.task_manager",ButtonIcons.TASK_MANAGER),
      // Open the Schematic Projects browser
      SCHEMATIC_PROJECTS_MANAGER("boxmatica.gui.button.change_menu.schematic_projects_manager",ButtonIcons.SCHEMATIC_PROJECTS),
      // In-game Configuration GUI
      CONFIGURATION("boxmatica.gui.button.change_menu.configuration_menu",ButtonIcons.CONFIGURATION),
      // Switch to the Boxmatica main menu
      MAIN_MENU("boxmatica.gui.button.change_menu.to_main_menu",null);
