...
import pama1234.boxmatica.gui.widgets.WidgetListTasks;
import pama1234.boxmatica.gui.widgets.WidgetTaskEntry;
...
public class GuiTaskManager extends GuiListBase<ITask,WidgetTaskEntry,WidgetListTasks>{
  public GuiTaskManager() {
    ...
    this.title=StringUtils.translate("boxmatica.gui.title.task_manager");
  }
