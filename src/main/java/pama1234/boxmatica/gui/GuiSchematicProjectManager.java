...
import pama1234.boxmatica.gui.widgets.WidgetListSchematicVersions;
import pama1234.boxmatica.gui.widgets.WidgetSchematicVersion;
...
public class GuiSchematicProjectManager extends GuiListBase<SchematicVersion,WidgetSchematicVersion,WidgetListSchematicVersions>
  ...
  public GuiSchematicProjectManager(SchematicProject project) {
    ...
    this.title=StringUtils.translate("boxmatica.gui.title.schematic_project_manager");
  }
  ...
  private static class ButtonListener implements IButtonActionListener{
    ...
    public void actionPerformedWithButton(ButtonBase button,int mouseButton) {
      if(this.type==Type.OPEN_PROJECT_BROWSER) {
        ...
        String title="boxmatica.gui.title.schematic_projects.confirm_place_to_world";
        String msg="boxmatica.gui.message.schematic_projects.confirm_place_to_world";
        ...
        String title="boxmatica.gui.title.schematic_projects.confirm_delete_area";
        String msg="boxmatica.gui.message.schematic_projects.confirm_delete_area";
        GuiConfirmAction gui=new GuiConfirmAction(320,title,executor,this.gui,msg);
        GuiBase.openGui(gui);
    ...
    public enum Type{
      CLOSE_PROJECT("boxmatica.gui.button.schematic_projects.close_project"),
      DELETE_AREA("boxmatica.gui.button.schematic_projects.delete_area","boxmatica.gui.button.hover.schematic_projects.delete_area"),
      MOVE_ORIGIN("boxmatica.gui.button.schematic_projects.move_origin_to_player","boxmatica.gui.button.hover.schematic_projects.move_origin_to_player"),
      OPEN_AREA_EDITOR("boxmatica.gui.button.schematic_projects.open_area_editor"),
      OPEN_PROJECT_BROWSER("boxmatica.gui.button.schematic_projects.open_project_browser"),
      PLACE_TO_WORLD("boxmatica.gui.button.schematic_projects.place_to_world","boxmatica.gui.button.hover.schematic_projects.place_to_world_warning"),
      SAVE_VERSION("boxmatica.gui.button.schematic_projects.save_version","boxmatica.gui.button.hover.schematic_projects.save_new_version");
