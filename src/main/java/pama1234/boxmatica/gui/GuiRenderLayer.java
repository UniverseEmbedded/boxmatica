...
public class GuiRenderLayer extends GuiRenderLayerEditBase{
  ...
  protected int createHotkeyCheckBoxes(int x,int y,LayerRange layerRange) {
    String label=StringUtils.translate("boxmatica.gui.label.render_layers.hotkey");
    String hover=StringUtils.translate("boxmatica.gui.label.render_layers.hover.hotkey");
