...
import pama1234.boxmatica.gui.widgets.WidgetListPlacementSubRegions;
import pama1234.boxmatica.gui.widgets.WidgetPlacementSubRegion;
...
public class GuiPlacementConfiguration extends GuiListBase<SubRegionPlacement,WidgetPlacementSubRegion,WidgetListPlacementSubRegions>
  ...
  public GuiPlacementConfiguration(SchematicPlacement placement) {
    ...
    this.title=StringUtils.translate("boxmatica.gui.title.configure_schematic_placement");
  }
  ...
  public void initGui() {
    ...
    String label=StringUtils.translate("boxmatica.gui.label.schematic_placement.sub_regions",this.placement.getSubRegionCount());
    ...
    label=StringUtils.translate("boxmatica.gui.label.placement_settings.placement_origin");
  ...
  protected void createCoordinateInput(int x,int y,int width,CoordinateType type) {
    ...
    String hover=StringUtils.translate("boxmatica.hud.schematic_placement.hover_info.lock_coordinate");
    x=x+offset+width+20;
  ...
  public int createButton(int x,int y,int width,ButtonListener.Type type) {
    ...
    switch(type) {
      case TOGGLE_ENCLOSING_BOX: {
        ...
        String str=(enabled?TXT_GREEN:TXT_RED)+StringUtils.translate("boxmatica.message.value."+(enabled?"on":"off"))+TXT_RST;
        String hover=StringUtils.translate("boxmatica.gui.button.schematic_placement.hover.enclosing_box",str);
      ...
      case TOGGLE_RENDERING: {
        ...
        String str=pre+StringUtils.translate("boxmatica.message.value."+(enabled?"on":"off"))+TXT_RST;
        String hover=StringUtils.translate("boxmatica.gui.button.schematic_placement.hover.rendering",str);
      ...
      case NUDGE_COORD_Y:
      case NUDGE_COORD_Z: {
        String hover=StringUtils.translate("boxmatica.gui.button.hover.plus_minus_tip");
  ...
  protected void updateElements() {
    String label=StringUtils.translate("boxmatica.gui.button.schematic_placement.reset_sub_region_placements");
    ;
  ...
  public static class ButtonListener implements IButtonActionListener{
    ...
    public enum Type{
      RENAME_PLACEMENT("boxmatica.gui.button.rename"),
      ROTATE("boxmatica.gui.button.rotation_value"),
      MIRROR("boxmatica.gui.button.mirror_value"),
      MOVE_TO_PLAYER("boxmatica.gui.button.move_to_player"),
      NUDGE_COORD_X(""),
      NUDGE_COORD_Y(""),
      NUDGE_COORD_Z(""),
      TOGGLE_ENABLED("boxmatica.gui.button.schematic_placements.placement_enabled"),
      TOGGLE_RENDERING("boxmatica.gui.button.schematic_placement.abbr.rendering"),
      TOGGLE_LOCKED("boxmatica.gui.button.schematic_placements.locked","boxmatica.gui.button.schematic_placement.hover.lock"),
      TOGGLE_ENTITIES("boxmatica.gui.button.schematic_placement.ignore_entities"),
      TOGGLE_ENCLOSING_BOX(""),
      TOGGLE_ALL_REGIONS_ON("boxmatica.gui.button.schematic_placement.toggle_all_on"),
      TOGGLE_ALL_REGIONS_OFF("boxmatica.gui.button.schematic_placement.toggle_all_off"),
      RESET_SUB_REGIONS(""),
      OPEN_VERIFIER_GUI("boxmatica.gui.button.schematic_verifier"),
      OPEN_MATERIAL_LIST_GUI("boxmatica.gui.button.material_list");
