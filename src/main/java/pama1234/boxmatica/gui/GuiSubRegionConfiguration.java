...
public class GuiSubRegionConfiguration extends GuiBase{
  ...
  public GuiSubRegionConfiguration(SchematicPlacement schematicPlacement,SubRegionPlacement placement) {
    ...
    this.title=StringUtils.translate("boxmatica.gui.title.configure_schematic_sub_region");
  }
  ...
  public void initGui() {
    ...
    String label=StringUtils.translate("boxmatica.gui.label.placement_sub.region_name",this.placement.getName());
    ...
    label=StringUtils.translate("boxmatica.gui.label.placement_sub.region_position");
    ...
    label=StringUtils.translate("boxmatica.gui.button.placement_sub.placement_configuration");
  ...
  private void updateElements() {
    String label=StringUtils.translate("boxmatica.gui.button.placement_sub.reset_sub_region_placement");
  ...
  private static class ButtonListener implements IButtonActionListener{
    ...
    public enum Type{
      ...
      TOGGLE_ENABLED("boxmatica.gui.button.schematic_placement.region_enabled"),
      ...
      RESET_PLACEMENT(""),
      SLICE_TYPE("boxmatica.gui.button.placement_sub.slice_type");
