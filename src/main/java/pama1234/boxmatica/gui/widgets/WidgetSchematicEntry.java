...
public class WidgetSchematicEntry extends WidgetListEntryBase<BoxmaticaSchematic>{
  ...
  public WidgetSchematicEntry(int x,int y,int width,int height,boolean isOdd,
    BoxmaticaSchematic schematic,int listIndex,WidgetListLoadedSchematics parent) {
  ...
  public void postRenderHovered(int mouseX,int mouseY,boolean selected,DrawContext drawContext) {
    ...
    if(this.schematic.getMetadata().wasModifiedSinceSaved()&&
      ...
      List<String> strs=ImmutableList.of(StringUtils.translate("boxmatica.gui.label.loaded_schematic.modified_on",str));
      ...
      if(fileName!=null) {
        ...
        lines.add(StringUtils.translate("boxmatica.gui.label.schematic_placement.in_memory"));
      }
  ...
  private static class ButtonListener implements IButtonActionListener{
    ...
    public void actionPerformedWithButton(ButtonBase button,int mouseButton) {
      if(this.type==Type.CREATE_PLACEMENT) {
        ...
        BoxmaticaSchematic entry=this.widget.schematic;
    ...
    public enum Type{
      CREATE_PLACEMENT("boxmatica.gui.button.create_placement"),
      RELOAD("boxmatica.gui.button.reload","boxmatica.gui.button.hover.schematic_list.reload_schematic"),
      SAVE_TO_FILE("boxmatica.gui.button.save_to_file"),
      UNLOAD("boxmatica.gui.button.unload");
