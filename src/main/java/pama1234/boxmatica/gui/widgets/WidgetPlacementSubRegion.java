...
public class WidgetPlacementSubRegion extends WidgetListEntryBase<SubRegionPlacement>{
  ...
  public void postRenderHovered(int mouseX,int mouseY,boolean selected,DrawContext drawContext) {
    BoxmaticaSchematic schematic=this.schematicPlacement.getSchematic();
    ...
    if(this.placement.isRegionPlacementModifiedFromDefault()&&
      ...
      String str=StringUtils.translate("boxmatica.hud.schematic_placement.hover_info.placement_sub_region_modified");
      ...
      text.add(StringUtils.translate("boxmatica.gui.label.schematic_placement.schematic_name",schematic.getMetadata().getName()));
      ...
      if(size!=null) {
        ...
        text.add(StringUtils.translate("boxmatica.gui.label.placement_sub.region_size",strSize));
      }
