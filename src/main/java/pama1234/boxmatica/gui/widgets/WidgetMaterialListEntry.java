...
import pama1234.boxmatica.materials.MaterialListBase.SortCriteria;
import pama1234.boxmatica.materials.MaterialListEntry;

public class WidgetMaterialListEntry extends WidgetListEntrySortable<MaterialListEntry>{
  private static final String[] HEADERS=new String[] {
    "boxmatica.gui.label.material_list.title.item",
    "boxmatica.gui.label.material_list.title.total",
    "boxmatica.gui.label.material_list.title.missing",
    "boxmatica.gui.label.material_list.title.available"};
  ...
  public WidgetMaterialListEntry(int x,int y,int width,int height,boolean isOdd,
    ...
    this.shulkerBoxAbbr=StringUtils.translate("boxmatica.gui.label.material_list.abbr.shulker_box");
  ...
  public void postRenderHovered(int mouseX,int mouseY,boolean selected,DrawContext drawContext) {
    if(this.entry!=null) {
      ...
      pama1234.boxmatica.render.RenderUtils.renderBackgroundMask(x+1,y+1,totalWidth-2,58,drawContext);
  ...
  static class ButtonListener implements IButtonActionListener{
    ...
    public enum ButtonType{
      IGNORE("boxmatica.gui.button.material_list.ignore");
