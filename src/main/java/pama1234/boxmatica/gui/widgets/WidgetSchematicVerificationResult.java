...
import pama1234.boxmatica.schematic.verifier.SchematicVerifier.SortCriteria;
...
public class WidgetSchematicVerificationResult extends WidgetListEntrySortable<BlockMismatchEntry>{
  ...
  public static final String HEADER_EXPECTED="boxmatica.gui.label.schematic_verifier.expected";
  public static final String HEADER_FOUND="boxmatica.gui.label.schematic_verifier.found";
  public static final String HEADER_COUNT="boxmatica.gui.label.schematic_verifier.count";
  ...
  public static class BlockMismatchInfo{
    ...
    public BlockMismatchInfo(BlockState stateExpected,BlockState stateFound) {
      ...
      w1=Math.max(w1,pama1234.boxmatica.render.RenderUtils.getMaxStringRenderLength(propsExpected));
      w2=Math.max(w2,pama1234.boxmatica.render.RenderUtils.getMaxStringRenderLength(propsFound));
    ...
    public void render(int x,int y,MinecraftClient mc,DrawContext drawContext) {
      if(this.stateExpected!=null&&this.stateFound!=null) {
        if(this.useBackgroundMask) {
          pama1234.boxmatica.render.RenderUtils.renderBackgroundMask(x+1,y+1,this.totalWidth-1,this.totalHeight-1,drawContext);
        }
        ...
        String strExpected=pre+StringUtils.translate("boxmatica.gui.label.schematic_verifier.expected")+GuiBase.TXT_RST;
        String strFound=pre+StringUtils.translate("boxmatica.gui.label.schematic_verifier.found")+GuiBase.TXT_RST;
  ...
  private static class ButtonListener implements IButtonActionListener{
    ...
    public enum ButtonType{
      IGNORE_MISMATCH("boxmatica.gui.button.schematic_verifier.ignore");
