...
public class WidgetSchematicVersion extends WidgetListEntryBase<SchematicVersion>{
  ...
  public void render(int mouseX,int mouseY,boolean selected,DrawContext drawContext) {
    ...
    String str=StringUtils.translate("boxmatica.gui.label.schematic_projects.version_entry",this.entry.getVersion(),this.entry.getName());
  ...
  public void postRenderHovered(int mouseX,int mouseY,boolean selected,DrawContext drawContext) {
    ...
    /*
     * text.add(StringUtils.translate("boxmatica.gui.label.schematic_placement.schematic_name",
     * this.placement.getSchematic().getMetadata().getName()));
     * text.add(StringUtils.translate("boxmatica.gui.label.schematic_placement.schematic_file",
     * fileName));
     * BlockPos o = this.placement.getOrigin();
     * String strOrigin = String.format("x: %d, y: %d, z: %d", o.getX(), o.getY(), o.getZ());
     * text.add(StringUtils.translate("boxmatica.gui.label.schematic_placement.origin",
     * strOrigin));
     * text.add(StringUtils.translate("boxmatica.gui.label.schematic_placement.sub_region_count",
     * String.valueOf(this.placement.getSubRegionCount())));
     * 
     * Vec3i size = this.placement.getSchematic().getTotalSize();
     * String strSize = String.format("%d x %d x %d", size.getX(), size.getY(), size.getZ());
     * text.add(StringUtils.translate("boxmatica.gui.label.schematic_placement.enclosing_size",
     * strSize));
     */
