...
import pama1234.boxmatica.gui.GuiSchematicProjectManager;
...
public class WidgetListSchematicVersions extends WidgetListBase<SchematicVersion,WidgetSchematicVersion>{
  ...
  protected void drawAdditionalContents(int mouseX,int mouseY,DrawContext drawContext) {
    ...
    str=StringUtils.translate("boxmatica.gui.label.schematic_projects.project");
    ...
    str=StringUtils.translate("boxmatica.gui.label.schematic_projects.version",strVer,w+this.project.getVersionCount()+r);
    this.drawString(drawContext,str,x,y,color);
    y+=12;
    ...
    if(version!=null) {
      ...
      str=StringUtils.translate("boxmatica.hud.schematic_projects.current_version_date",w+str+r);
      this.drawString(drawContext,str,x,y,color);
      y+=12;

      str=StringUtils.translate("boxmatica.gui.label.schematic_projects.version_name");
      this.drawString(drawContext,str,x,y,color);
      y+=12;
      this.drawString(drawContext,w+version.getName()+r,x+4,y,color);
      y+=12;
      str=StringUtils.translate("boxmatica.gui.label.schematic_projects.origin");
      this.drawString(drawContext,str,x,y,color);
      y+=12;
