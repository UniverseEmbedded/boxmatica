  ...
  public void postRenderHovered(int mouseX,int mouseY,boolean selected,DrawContext drawContext) {
    ...
    if(selection!=null) {
      ...
      if(o==null) {
        ...
        str=StringUtils.translate("boxmatica.gui.label.origin.auto");
      }else {
        str=StringUtils.translate("boxmatica.gui.label.origin.manual");
      }

      String strOrigin=String.format("x: %d, y: %d, z: %d (%s)",o.getX(),o.getY(),o.getZ(),str);
      text.add(StringUtils.translate("boxmatica.gui.label.area_selection_origin",strOrigin));

      int count=selection.getAllSubRegionBoxes().size();
      text.add(StringUtils.translate("boxmatica.gui.label.area_selection_box_count",count));
    }
  ...
  private static class ButtonListener implements IButtonActionListener{
    ...
    public void actionPerformedWithButton(ButtonBase button,int mouseButton) {
      ...
      if(this.type==ButtonType.RENAME) {
        String title="boxmatica.gui.title.rename_area_selection";
        ...
        if(selection!=null) {
          String title=StringUtils.translate("boxmatica.gui.title.copy_area_selection",selection.getName());
          ...
          this.widget.parent.getSelectionManagerGui().addMessage(MessageType.ERROR,"boxmatica.error.area_selection.failed_to_load");
        }
    ...
    public enum ButtonType{
      RENAME("boxmatica.gui.button.rename"),
      COPY("boxmatica.gui.button.copy"),
      CONFIGURE("boxmatica.gui.button.configure"),
