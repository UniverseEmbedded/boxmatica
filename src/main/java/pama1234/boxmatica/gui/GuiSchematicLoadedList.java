...
import pama1234.boxmatica.gui.widgets.WidgetListLoadedSchematics;
import pama1234.boxmatica.gui.widgets.WidgetSchematicEntry;
import pama1234.boxmatica.schematic.BoxmaticaSchematic;
import fi.dy.masa.malilib.gui.GuiListBase;
import fi.dy.masa.malilib.gui.button.ButtonGeneric;
import fi.dy.masa.malilib.util.StringUtils;

public class GuiSchematicLoadedList extends GuiListBase<BoxmaticaSchematic,WidgetSchematicEntry,WidgetListLoadedSchematics>{
  public GuiSchematicLoadedList() {
    super(12,30);

    this.title=StringUtils.translate("boxmatica.gui.title.manage_loaded_schematics");
  }
