package pama1234.boxmatica.schematic.conversion;
...
import pama1234.boxmatica.mixin.block.IMixinFenceGateBlock;
import pama1234.boxmatica.mixin.block.IMixinRedstoneWireBlock;
import pama1234.boxmatica.mixin.block.IMixinStairsBlock;
import pama1234.boxmatica.mixin.block.IMixinVineBlock;
...
public class SchematicConversionFixers{
    ...
    if(tag!=null&&tag.contains("Base")) {
      ...
      if(colorOrig!=colorFromData) {
        ...
        switch(colorFromData) {
          case WHITE:
            state=Blocks.WHITE_BANNER.getDefaultState();
            break;
          case ORANGE:
            state=Blocks.ORANGE_BANNER.getDefaultState();
            break;
          case MAGENTA:
            state=Blocks.MAGENTA_BANNER.getDefaultState();
            break;
          case LIGHT_BLUE:
            state=Blocks.LIGHT_BLUE_BANNER.getDefaultState();
            break;
          case YELLOW:
            state=Blocks.YELLOW_BANNER.getDefaultState();
            break;
          case LIME:
            state=Blocks.LIME_BANNER.getDefaultState();
            break;
          case PINK:
            state=Blocks.PINK_BANNER.getDefaultState();
            break;
          case GRAY:
            state=Blocks.GRAY_BANNER.getDefaultState();
            break;
          case LIGHT_GRAY:
            state=Blocks.LIGHT_GRAY_BANNER.getDefaultState();
            break;
          case CYAN:
            state=Blocks.CYAN_BANNER.getDefaultState();
            break;
          case PURPLE:
            state=Blocks.PURPLE_BANNER.getDefaultState();
            break;
          case BLUE:
            state=Blocks.BLUE_BANNER.getDefaultState();
            break;
          case BROWN:
            state=Blocks.BROWN_BANNER.getDefaultState();
            break;
          case GREEN:
            state=Blocks.GREEN_BANNER.getDefaultState();
            break;
          case RED:
            state=Blocks.RED_BANNER.getDefaultState();
            break;
          case BLACK:
            state=Blocks.BLACK_BANNER.getDefaultState();
            break;
        }
  ...
  public static final IStateFixer FIXER_BANNER_WALL=(reader,state,pos)-> {
    ...
    if(tag!=null&&tag.contains("Base")) {
      ...
      if(colorOrig!=colorFromData) {
        ...
        switch(colorFromData) {
          case WHITE:
            state=Blocks.WHITE_WALL_BANNER.getDefaultState();
            break;
          case ORANGE:
            state=Blocks.ORANGE_WALL_BANNER.getDefaultState();
            break;
          case MAGENTA:
            state=Blocks.MAGENTA_WALL_BANNER.getDefaultState();
            break;
          case LIGHT_BLUE:
            state=Blocks.LIGHT_BLUE_WALL_BANNER.getDefaultState();
            break;
          case YELLOW:
            state=Blocks.YELLOW_WALL_BANNER.getDefaultState();
            break;
          case LIME:
            state=Blocks.LIME_WALL_BANNER.getDefaultState();
            break;
          case PINK:
            state=Blocks.PINK_WALL_BANNER.getDefaultState();
            break;
          case GRAY:
            state=Blocks.GRAY_WALL_BANNER.getDefaultState();
            break;
          case LIGHT_GRAY:
            state=Blocks.LIGHT_GRAY_WALL_BANNER.getDefaultState();
            break;
          case CYAN:
            state=Blocks.CYAN_WALL_BANNER.getDefaultState();
            break;
          case PURPLE:
            state=Blocks.PURPLE_WALL_BANNER.getDefaultState();
            break;
          case BLUE:
            state=Blocks.BLUE_WALL_BANNER.getDefaultState();
            break;
          case BROWN:
            state=Blocks.BROWN_WALL_BANNER.getDefaultState();
            break;
          case GREEN:
            state=Blocks.GREEN_WALL_BANNER.getDefaultState();
            break;
          case RED:
            state=Blocks.RED_WALL_BANNER.getDefaultState();
            break;
          case BLACK:
            state=Blocks.BLACK_WALL_BANNER.getDefaultState();
            break;
        }
  ...
  public static final IStateFixer FIXER_BED=(reader,state,pos)-> {
    ...
    if(tag!=null&&tag.contains("color")) {
      ...
      switch(colorId) {
        case 0:
          state=Blocks.WHITE_BED.getDefaultState();
          break;
        case 1:
          state=Blocks.ORANGE_BED.getDefaultState();
          break;
        case 2:
          state=Blocks.MAGENTA_BED.getDefaultState();
          break;
        case 3:
          state=Blocks.LIGHT_BLUE_BED.getDefaultState();
          break;
        case 4:
          state=Blocks.YELLOW_BED.getDefaultState();
          break;
        case 5:
          state=Blocks.LIME_BED.getDefaultState();
          break;
        case 6:
          state=Blocks.PINK_BED.getDefaultState();
          break;
        case 7:
          state=Blocks.GRAY_BED.getDefaultState();
          break;
        case 8:
          state=Blocks.LIGHT_GRAY_BED.getDefaultState();
          break;
        case 9:
          state=Blocks.CYAN_BED.getDefaultState();
          break;
        case 10:
          state=Blocks.PURPLE_BED.getDefaultState();
          break;
        case 11:
          state=Blocks.BLUE_BED.getDefaultState();
          break;
        case 12:
          state=Blocks.BROWN_BED.getDefaultState();
          break;
        case 13:
          state=Blocks.GREEN_BED.getDefaultState();
          break;
        case 14:
          state=Blocks.RED_BED.getDefaultState();
          break;
        case 15:
          state=Blocks.BLACK_BED.getDefaultState();
          break;
        default:
          return state;
      }
  ...
  public static final IStateFixer FIXER_FENCE_GATE=(reader,state,pos)-> {
    ...
    if(facing.getAxis()==Direction.Axis.X) {
      inWall=(((IMixinFenceGateBlock)gate).boxmatica_invokeIsWall(reader.getBlockState(pos.offset(Direction.NORTH)))
        ||((IMixinFenceGateBlock)gate).boxmatica_invokeIsWall(reader.getBlockState(pos.offset(Direction.SOUTH))));
    }else {
      inWall=(((IMixinFenceGateBlock)gate).boxmatica_invokeIsWall(reader.getBlockState(pos.offset(Direction.WEST)))
        ||((IMixinFenceGateBlock)gate).boxmatica_invokeIsWall(reader.getBlockState(pos.offset(Direction.EAST))));
    }
  ...
  public static final IStateFixer FIXER_REDSTONE_WIRE=(reader,state,pos)-> {
    ...
    BlockState stateAdj=((IMixinRedstoneWireBlock)wire).boxmatica_GetPlacementState(reader,state,pos);
  ...
  public static final IStateFixer FIXER_STAIRS=(reader,state,pos)-> {
    return state.with(StairsBlock.SHAPE,IMixinStairsBlock.boxmatica_invokeGetStairShape(state,reader,pos));
  };

  public static final IStateFixer FIXER_STEM=(reader,state,pos)-> {
    /*
     * FIXME 1.20.3 - the gourd block and attached stem are now RegistryKey<Block>, plus they are
     * private...
  ...
  public static final IStateFixer FIXER_VINE=(reader,state,pos)-> {
    ...
    return state.with(VineBlock.UP,((IMixinVineBlock)vine).boxmatica_invokeShouldConnectUp(reader,pos.up(),Direction.UP));
  };
