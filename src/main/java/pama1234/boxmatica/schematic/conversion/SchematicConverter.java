...
public class SchematicConverter{
  ...
  public static SchematicConverter createForBoxmatica() {
    SchematicConverter converter=new SchematicConverter();
    converter.addPostUpdateBlocksBoxmatica();
    return converter;
  }
  ...
  public NbtCompound fixTileEntityNBT(NbtCompound tag,BlockState state) {
     ...
     * try
     * {
     * tag = (NBTTagCompound) this.mc.getDataFixer().update(TypeReferences.BLOCK_ENTITY, new
     * Dynamic<>(NBTDynamicOps.INSTANCE, tag),
     * 1139, BoxmaticaSchematic.MINECRAFT_DATA_VERSION).getValue();
     * }
     * catch (Throwable e)
     * {
     * Boxmatica.logger.warn("Failed to update BlockEntity data for block '{}'", state, e);
     * }
     */
  ...
  public static void postProcessBlocks(BoxmaticaBlockStateContainer container,@Nullable Map<BlockPos,NbtCompound> tiles,
    ...
    BlockReaderBoxmaticaContainer reader=new BlockReaderBoxmaticaContainer(container,tiles);
  ...
  private void addPostUpdateBlocksBoxmatica() {
  ...
  public static class BlockReaderBoxmaticaContainer implements IBlockReaderWithData{
    private final BoxmaticaBlockStateContainer container;
    private final Map<BlockPos,NbtCompound> blockEntityData;
    private final Vec3i size;
    private final BlockState air;

    public BlockReaderBoxmaticaContainer(BoxmaticaBlockStateContainer container,@Nullable Map<BlockPos,NbtCompound> blockEntityData) {
