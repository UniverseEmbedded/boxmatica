...
import pama1234.boxmatica.gui.GuiSchematicProjectsBrowser;
...
public class SchematicProjectsManager{
  ...
  public void openSchematicProjectsGui() {
    if(Configs.Generic.UNHIDE_SCHEMATIC_PROJECTS.getBooleanValue()==false) {
      InfoUtils.showGuiOrInGameMessage(MessageType.WARNING,10000,"boxmatica.message.warning.schematic_projects_hidden");
      return;
    }
  ...
  public boolean cycleVersion(int amount) {
    if(this.currentProject!=null) {
      ...
      InfoUtils.showGuiOrInGameMessage(MessageType.ERROR,"boxmatica.error.schematic_projects.no_project_open");
    }
