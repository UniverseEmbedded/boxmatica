package pama1234.boxmatica.schematic.verifier;
...
import pama1234.boxmatica.render.infohud.IInfoHudRenderer;
...
public class SchematicVerifier extends TaskBase implements IInfoHudRenderer{
  ...
  public SchematicVerifier() {
    this.name=StringUtils.translate("boxmatica.gui.label.schematic_verifier.verifier");
  }
  ...
  public List<Pair<BlockState,BlockState>> getIgnoredStateMismatchPairs(GuiBase gui) {
    ...
    try {
      ...
      gui.addMessage(MessageType.ERROR,"boxmatica.error.generic.failed_to_sort_list_of_ignored_states");
    }
  ...
  private void updateMismatchPositionStringList(@Nullable MismatchType mismatchType,List<MismatchRenderPos> positionList) {
    ...
    if(positionList.isEmpty()==false) {
      ...
      if(mismatchType!=null) {
        ...
        String title=StringUtils.translate("boxmatica.gui.title.schematic_verifier_errors");
   ...
   * <b>NOTE:</b> This is actually the instance of this class, there are no separate providers for
   * different data types atm!
   */
  /*
  ...
  public static class BlockMismatch implements Comparable<BlockMismatch>{
    ...
    public boolean equals(Object obj) {
      ...
      }else if(stateExpected!=other.stateExpected) return false;
      if(stateFound==null) {
        if(other.stateFound!=null) return false;
      }else if(stateFound!=other.stateFound) return false;
      return true;
    }
  }
  ...
  public enum MismatchType{
    ALL(0xFF0000,"boxmatica.gui.label.schematic_verifier_display_type.all",GuiBase.TXT_WHITE),
    MISSING(0x00FFFF,"boxmatica.gui.label.schematic_verifier_display_type.missing",GuiBase.TXT_AQUA),
    EXTRA(0xFF00CF,"boxmatica.gui.label.schematic_verifier_display_type.extra",GuiBase.TXT_LIGHT_PURPLE),
    WRONG_BLOCK(0xFF0000,"boxmatica.gui.label.schematic_verifier_display_type.wrong_blocks",GuiBase.TXT_RED),
    WRONG_STATE(0xFFAF00,"boxmatica.gui.label.schematic_verifier_display_type.wrong_state",GuiBase.TXT_GOLD),
    CORRECT_STATE(0x11FF11,"boxmatica.gui.label.schematic_verifier_display_type.correct_state",GuiBase.TXT_GREEN),
    DIFF_BLOCK(0xFAF000,"boxmatica.gui.label.schematic_verifier_display_type.diff_blocks",GuiBase.TXT_YELLOW);
