...
public class BoxmaticaBitArray{
  public static final Codec<BoxmaticaBitArray> CODEC=RecordCodecBuilder.create(
    inst->inst.group(
      ...
      .apply(inst,BoxmaticaBitArray::new));
  public static final PacketCodec<ByteBuf,BoxmaticaBitArray> PACKET_CODEC=new PacketCodec<>() {
    @Override
    public void encode(ByteBuf buf,BoxmaticaBitArray value) {
    ...
    @Override
    public BoxmaticaBitArray decode(ByteBuf buf) {
      return new BoxmaticaBitArray(
  ...
  public BoxmaticaBitArray(int bitsPerEntryIn,long arraySizeIn) {
    this(bitsPerEntryIn,arraySizeIn,(long[])null);
  }

  public BoxmaticaBitArray(int bitsPerEntryIn,long arraySizeIn,@Nullable long[] longArrayIn) {
  ...
  private BoxmaticaBitArray(int bitsPerEntryIn,long arraySizeIn,LongStream longArrayIn) {
