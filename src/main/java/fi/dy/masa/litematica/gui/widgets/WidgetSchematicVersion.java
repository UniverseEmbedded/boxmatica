...
public class WidgetSchematicVersion extends WidgetListEntryBase<SchematicVersion>{
  ...
  public void postRenderHovered(int mouseX,int mouseY,boolean selected,DrawContext drawContext) {
    ...
    /*
     * text.add(StringUtils.translate("litematica.gui.label.schematic_placement.schematic_name",
     * this.placement.getSchematic().getMetadata().getName()));
     * text.add(StringUtils.translate("litematica.gui.label.schematic_placement.schematic_file",
     * fileName));
     * BlockPos o = this.placement.getOrigin();
     * String strOrigin = String.format("x: %d, y: %d, z: %d", o.getX(), o.getY(), o.getZ());
     * text.add(StringUtils.translate("litematica.gui.label.schematic_placement.origin",
     * strOrigin));
     * text.add(StringUtils.translate("litematica.gui.label.schematic_placement.sub_region_count",
     ...
     * text.add(StringUtils.translate("litematica.gui.label.schematic_placement.enclosing_size",
     * strSize));
     */
