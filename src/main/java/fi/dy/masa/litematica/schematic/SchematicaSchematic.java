...
public class SchematicaSchematic{
   ...
   * "litematica.error.schematic_write_to_file_failed.directory_creation_failed",
   * dir.getAbsolutePath()));
   * return false;
   * }
   * 
   ...
   * {
   * feedback.setString(StringUtils.translate(
   * "litematica.error.schematic_write_to_file_failed.exists", fileSchematic.getAbsolutePath()));
   * return false;
   * }
   * 
   ...
   * {
   * feedback.setString(StringUtils.translate(
   * "litematica.error.schematic_write_to_file_failed.exception",
